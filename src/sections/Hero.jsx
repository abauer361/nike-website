    ...
    <section id="home" className="w-full flex xl:flex-row flex-col
     justify-center min-h-screen gap-10 max-container">
      ...
      items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[48px] max-sm:leading-[60px] font-bold">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-white bg-hero bg-cover bg-center">
        <img 
          src={bigShoeImg}
          alt="shoe collection"
          width={610}
